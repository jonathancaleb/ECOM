...
import 'package:am_ecom/view/screens/checkout/widget/payment_button_new.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          return Column(children: [
            ...
            SizedBox(
                height:
                    isCashOnDeliveryActive ? Dimensions.paddingSizeSmall : 0),
            storeId == null && isDigitalPaymentActive
                ? PaymentButtonNew(
                ...
                : const SizedBox(),
            SizedBox(
                height: storeId == null && isDigitalPaymentActive
                    ? Dimensions.paddingSizeSmall
                    : 0),
            storeId == null && isWalletActive
                ? PaymentButtonNew(
                    icon: Images.wallet,

...
import 'package:am_ecom/helper/custom_validator.dart';
...
import 'package:am_ecom/view/screens/auth/widget/condition_check_box.dart';
import 'package:am_ecom/view/screens/auth/widget/pass_view.dart';
...
class _DeliveryManRegistrationScreenState
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        ...
        return SafeArea(
            child: ResponsiveHelper.isDesktop(context)
                ? webView(authController, zoneIndexList, dmTypeList)
                : Column(children: [
                    Padding(
  ...
  Widget webView(AuthController authController, List<int> zoneIndexList,
                    ...
                    child: Column(children: [
                                  ...
                                  ? Container(
                                      ...
                                      child: DropdownButton<int>(
                                        ...
                                        items: authController.vehicleIds!
                                            .map((int? value) {
                                          return DropdownMenuItem<int>(
                                            value: authController.vehicleIds!
                                                .indexOf(value),
                                            child: Text(value != 0
                                                ? authController
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            XFile? file =
                                index == authController.pickedIdentities.length
                                    ? null
